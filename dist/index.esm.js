...
var Button = function (_a) {
    ...
    return (React.createElement(StyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled, className: "btnOuter" }),
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "87", height: "30", href: isDark ? 'images/slime/navw.png' : 'images/slime/navb.png' })));
};
...
var PanelBody = function (_a) {
    ...
    // Close the menu when a user clicks a link on mobile
    var handleClick = isMobile ? function () { return pushNav(false); } : undefined;
    return (React.createElement(Container$1, null,React.createElement("img", { width: "160", height: "51", src: isDark ? 'images/slime/navw.png' : 'images/slime/navb.png', alt: "navimg", className: "navlogo" }), links.map(function (entry) {
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement("div", { className: "panelFooter" },
            React.createElement("h2", null, "Stake tokens to earn slime"),
            React.createElement(Button, null, "Go to Pools")),
        React.createElement(SocialEntry, null, cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank", style: { margin: "auto" } },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f1f8ff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#f6f8fa", tertiary: "#E0E0E0", text: "#000000", textDisabled: "#BDC2C4", textSubtle: "#000000", borderColor: "#E9EAEB", card: "#fcfeff", lgray: "#92939b", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#6bb7f9", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "transparent", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", lgray: "#92939b", gradients: {
...
var _a$2, _b;
var PRIMARY = variants.PRIMARY, SECONDARY = variants.SECONDARY, TERTIARY = variants.TERTIARY, TEXT = variants.TEXT, DANGER = variants.DANGER, SUBTLE = variants.SUBTLE, SUCCESS = variants.SUCCESS, DISABLED = variants.DISABLED;
var light$1 = (_a$2 = {},
    _a$2[PRIMARY] = {
...
var dark$1 = (_b = {},
    ...
    _b[DISABLED] = __assign({}, light$1.disabled),
    _b);
